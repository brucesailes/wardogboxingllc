    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-4 sm:px-6 lg:px-8">
        <div className="p-2 transition-all duration-300 transform hover:scale-105">
          <Image src="/slide1.png" alt="Image 1" width={500} height={400} />
        </div>

        <div className="p-2 transition-all duration-300 transform hover:scale-105">
          <Image src="/slide2.png" alt="Image 2" width={500} height={400} />
        </div>

        <div className="p-2 transition-all duration-300 transform hover:scale-105">
          <Image src="/slide3.png" alt="Image 3"  width={500} height={400} />
        </div>
