  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white text-blue-500 p-6 shadow-xl rounded-xl text-center transition-all duration-300 transform hover:scale-105 flex flex-col justify-between">
          <div className="flex-grow">
            <h2 className={`${styles.bookingHeader} text-2xl md:text-3xl font-bold mb-4`}>1 session per Week</h2>
        ...
        <div className="bg-white text-blue-500 p-6 shadow-xl rounded-xl text-center transition-all duration-300 transform hover:scale-105 flex flex-col justify-between">
          <div className="flex-grow">
            <h2 className={`${styles.bookingHeader} text-2xl md:text-3xl font-bold mb-4`}>2 sessions per Week</h2>
        ...
        <div className="bg-white text-blue-500 p-6 shadow-xl rounded-xl text-center transition-all duration-300 transform hover:scale-105 flex flex-col justify-between">
          <div className="flex-grow">
            <h2 className={`${styles.bookingHeader} text-2xl md:text-3xl font-bold mb-4`}>3 sessions per Week</h2>
