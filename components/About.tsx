...
export default function About() {
    return (
        <main className="flex flex-col  text-center text-blue-500 items-center justify-center min-h-screen mt-20">
            ...
            <section className="w-full max-w-4xl mx-auto p-8 rounded-xl shadow-xl space-y-6">
                <div className="flex justify-center items-center p-6">
                    <div className="w-64 h-64 md:w-96 md:h-96 relative overflow-hidden rounded-full drop-shadow-lg transition-all duration-300 transform hover:scale-105">
                ...
                <div className='flex justify-center items-center text-center text-l md:text-xl text-center leading-relaxed transition-all duration-300 transform hover:scale-105'>
                    <p>
