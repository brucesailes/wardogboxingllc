        ...
        <div className="text-center mt-20 p-4">
            <div className="inline-block text-left border border-gray-300 p-8 rounded-lg">
                ...
                <ul className="mt-4 list-none p-0 text-center">
                    <li className="mb-2"><a href="https://www.instagram.com/wardogboxing/?igsh=ZmV3c2tvMTl3NzVu" target="_blank" rel='noopener' className="text-purple-500 hover:text-blue-700"><FontAwesomeIcon icon={faInstagram} /> Instagram</a></li>
